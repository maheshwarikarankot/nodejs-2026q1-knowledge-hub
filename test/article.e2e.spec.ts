...
describe('Article (e2e)', () => {
  ...
  describe('GET (filtering)', () => {
    ...
    it('should correctly filter articles by categoryId', async () => {
      ...
      const hasWithCat = response.body.data.some((a) => a.id === articleWithCatId);
      const hasWithoutCat = response.body.data.some((a) => a.id === articleWithoutCatId);
    ...
    it('should correctly filter articles by tag', async () => {
      ...
      const hasUntagged = response.body.data.some((a) => a.id === noTagArticleId);
